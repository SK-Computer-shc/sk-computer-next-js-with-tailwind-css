    ...
    <div>
      ...
      <div className="flex flex-wrap shadow-sm my-2 rounded-xl font-mono justify-evenly">
        ...
        <div className="max-w-lg">
          <img className="rounded-2xl" src="/assets/SK-Computer-main-bg.29157249.29157249.jpg" alt="Sk Computer saharsa backgrond image" />
        </div>
      </div>
      ...
      <p
        className="text-center my-20 text-4xl font-semibold text-blue-700 font-serif underline underline-offset-4 capitalize">
