...
export default function home() {
  return (
    <div>
      ...
      <div className='text-2xl font-mono border-l-4 border-b-2 text-gray-400'>
      ...
      <div className="flex flex-wrap justify-evenly">
        ...
        <div className="">
          ...
          <ul className="flex my-5 justify-center">
            <li className="h-10 w-10 mx-1 hover:opacity-90"><Link href="https://www.facebook.com/SK.Computer.Saharsa"><a target="_blank">
            ...
            <li className="h-14 w-14 mx-1 hover:opacity-90"><Link href="https://twitter.com/SK_Computer_SHC" ><a target="_blank"> <Image
              src="/assets/Twitter.a4a5c77e.a4a5c77e.png" width={40} height={40} alt="Twitter" /></a></Link></li>
            <li className="h-14 w-14 mx-1 hover:opacity-90"><Link href="https://sk-electronics-printers-baghwa-saharsa.business.site"><a
              target="_blank"> <Image
                src="/assets/google+.aaaf9934.aaaf9934.png" width={40} height={40} alt="Google+" /></a></Link></li>
            <li className="h-14 w-14 mx-1 hover:opacity-90"><Link href="https://g.co/kgs/X1JT4g"><a target="_blank" > <Image
              src="/assets/Google.8ec17930.8ec17930.png" width={40} height={40} alt="Google" /></a></Link></li>
            <li className="h-14 w-14 mx-1 hover:opacity-90"><Link href="https://wa.me/+919939527286"><a target="_blank" > <Image
